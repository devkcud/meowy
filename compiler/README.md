...
integer blocks with immutable locals and one primary emission. Field/imported data and
helper calls remain unproven. Non-integer/mutable scratch and full required

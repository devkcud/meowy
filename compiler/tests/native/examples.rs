...
pub fn examples_execute_in_both_profiles() {
    for (source, stdout) in [
        (
            include_str!("../../examples/computed-types.mwy"),
            "computed\n7\n",
        ),
        (
            include_str!("../../examples/carried-writes.mwy"),
            "row\nitem\nrhs\n7\n3\n0\n8\n9\n",
        ),
        (
            include_str!("../../examples/exclusive-carried-elements.mwy"),
            "1\n7\n3\n2\n0\n8\n",
        ),
        (
            include_str!("../../examples/exclusive-carried-list-fields.mwy"),
            "1\n3\n0\n8\n2\n",
        ),
        (
            include_str!("../../examples/carried-list-borrows.mwy"),
            "init\n8\n8\n8\n2\n0\n",
        ),
        (
            include_str!("../../examples/binding-fields.mwy"),
            "8\n9\n11\n",
        ),
        (
            include_str!("../../examples/carried-lists.mwy"),
            "init\n2\n3\n3\n",
        ),
        (
            include_str!("../../examples/pointer-syntax.mwy"),
            "7\n7\n8\n20\n20\ntrue\n20\n",
        ),
        (
            include_str!("../../examples/exclusive-carried-records.mwy"),
            "7\n8\nready\n",
        ),
        (
            include_str!("../../examples/carried-record-borrows.mwy"),
            "init\n7\n7\n7\nready\n",
        ),
        (
            include_str!("../../examples/carried-records.mwy"),
            "init\n7\nready\n",
        ),
        ...
        (
            include_str!("../../examples/carried-scalars.mwy"),
            "init\n0\n1\n2\n7\n",
        ),
        (
        ...
        (
            include_str!("../../examples/alias-restarts.mwy"),
            "7\n7\n9\n8\n",
        ),
        (

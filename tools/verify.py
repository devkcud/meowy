...
def main():
    ...
    if runtime:
        print("Native cleanup, guarded stacks, contexts, child waits, owned values and explicit scope close are selected; automatic cancellation/scope-exit joins and DWARF unwinding remain unqualified.", flush=True)
    if not editor:
